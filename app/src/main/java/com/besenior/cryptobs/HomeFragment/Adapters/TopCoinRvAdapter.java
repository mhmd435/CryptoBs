...
import com.besenior.cryptobs.databinding.TopmarketItemBinding;
...
public class TopCoinRvAdapter extends RecyclerView.Adapter<TopCoinRvAdapter.TopCoinRvHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull TopCoinRvHolder holder, @SuppressLint("RecyclerView") int position) {
